...
public class SimuladorFrontEnd {
    public static void main(String[] args) {
        classe.metodos.MetodosGestaoHospitalar metodos = new classe.metodos.MetodosGestaoHospitalar();
